...
<h1>Listado de Menu</h1><br>
<div class="busqueda" style="width: 50%; text-align: right">
    <form action="${pageContext.servletContext.contextPath}/Rol" method="get">
...
<div class="buttons" >
    <ul>
        <li><a
                href="${pageContext.servletContext.contextPath}/Menus?accion=insertar">Nuevo</a></li>
    </ul>
</div>
<br/>
${tabla}

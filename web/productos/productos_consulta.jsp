...
<div class="busqueda" style="width: 50%; text-align: right">
    <form action="${pageContext.servletContext.contextPath}/Productos" method="get">
...
<div class="buttons" >
    <ul>
        <li><a href="${pageContext.servletContext.contextPath}/Productos?accion=insertar">Nuevo</a></li>
    </ul>
</div>
<br/>
${tabla}

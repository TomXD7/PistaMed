...
<div class="busqueda" style="width: 50%; text-align: right">
    <form action="${pageContext.servletContext.contextPath}/Usuarios" method="get">
...
<div class="buttons" >
    <ul>
        <li><a href="${pageContext.servletContext.contextPath}/Usuarios?accion=insertar">Nuevo</a></li>
    </ul>
</div>
<br/>
${tabla}
